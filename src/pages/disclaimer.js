  ...
  render() {
    return (
      <div className="disclaimer">
        <h3>
          You’re almost ready to get started! Please read our terms of use
          below.{" "}
        </h3>
        <p>
        ...
        <p>
          ...
          and agree not to hold us liable for any disputes arising from the
          lease you create or review using this tool.
        </p>
        <p>
