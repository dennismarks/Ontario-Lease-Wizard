  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>
          Move the sliders below to tell us about what issues are most important
          to you.
        </p>
        <p>
          We’ll use this information to highlight parts of the lease that can
        ...
        <form>
          <input
            value={this.state.concernText}
            onChange={this.updateConcernInput}
            type="text"
